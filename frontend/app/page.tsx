    ...
    <div className="min-h-screen bg-white font-sans text-zinc-900 selection:bg-red-900 selection:text-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center mt-10">
          ...
          <p className="text-xl text-zinc-300 mb-10 max-w-3xl mx-auto leading-relaxed drop-shadow-lg font-light">
            A centralized system for the extraction, tracking, and compliance validation of complex commercial loan agreements.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
                ...
                <div className="space-y-8">
                    ...
                    <h2 className="text-4xl font-bold text-zinc-900 tracking-tight">Manual Compliance Failure.</h2>
                    <p className="text-lg text-zinc-600 leading-relaxed">
                        Commercial lending relies on unstructured legal documents. Tracking covenants manually leads to operational inefficiency and significant regulatory exposure.
                    </p>
                    <div className="space-y-4">
                        <ProblemCard title="Data Fragmentation" desc="Critical obligations trapped in PDF silos." delay="0" />
                        <ProblemCard title="Human Error" desc="Manual financial spreading has a high error rate." delay="100" />
                        <ProblemCard title="Governance Gaps" desc="Lack of real-time audit trails for compliance checks." delay="200" />
                    </div>
                </div>

                {/* The Solution (Professional Tone) */}
                <div className="relative">
                    <div className="absolute inset-0 bg-linear-to-tr from-zinc-200 to-white rounded-3xl -rotate-2 scale-105 z-0 border border-zinc-200" />
                    <div className="relative z-10 bg-white text-zinc-900 p-10 rounded-3xl shadow-xl border border-zinc-200">
                        ...
                        <h3 className="text-3xl font-bold mb-6">AI-Driven Risk Control.</h3>
                        <p className="text-zinc-600 mb-8 leading-relaxed">
                            Covenant IQ utilizes Large Language Models to digitize legal frameworks into monitorable data points, ensuring continuous compliance assurance.
                        </p>
                        <div className="space-y-6">
                            <SolutionItem icon={<Zap className="text-amber-500"/>} title="Automated Extraction" text="Digitizes financial covenants & definitions instantly." />
                            <SolutionItem icon={<Lock className="text-blue-500"/>} title="Continuous Monitoring" text="Real-time validation of borrower financials vs. limits." />
                            <SolutionItem icon={<CheckCircle2 className="text-green-600"/>} title="Regulatory Reporting" text="Generates immutable compliance certificates." />
                        </div>
                    </div>
                </div>
      ...
      <section className="py-24 bg-white border-t border-zinc-200">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                <MetricCard number="90%" label="Efficiency Gain" desc="Reduction in document processing time." icon={<Clock className="h-6 w-6 text-red-600" />} />
                <MetricCard number="100%" label="Data Accuracy" desc="Elimination of manual transcription errors." icon={<ShieldCheck className="h-6 w-6 text-green-600" />} />
                <MetricCard number="24/7" label="Risk Oversight" desc="Continuous monitoring vs. quarterly reviews." icon={<BarChart3 className="h-6 w-6 text-blue-600" />} />
            </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-zinc-900 text-center text-white">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-4xl font-bold mb-8 tracking-tight">Modernize your credit workflow.</h2>
          <Link href="/dashboard">
            <Button size="lg" className="h-16 px-12 text-xl font-bold bg-red-600 hover:bg-red-700 text-white shadow-xl shadow-red-900/20 rounded-full transition-all hover:scale-105">
...
function ProblemCard({ title, desc }: any) {
  return (
    <div className="flex items-start gap-4 p-4 rounded-xl border border-zinc-200 bg-white hover:shadow-md transition-all duration-300">
        <div className="mt-1 bg-red-50 p-2 rounded-lg border border-red-100"><XCircle className="h-5 w-5 text-red-600" /></div>
        <div>
...
function MetricCard({ number, label, desc, icon }: any) {
    return (
        <div className="flex flex-col items-center text-center p-8 bg-zinc-50 rounded-2xl border border-zinc-100 hover:border-zinc-300 transition-colors">
            <div className="mb-5 p-4 bg-white rounded-full shadow-sm border border-zinc-100">{icon}</div>
            <div className="text-5xl font-extrabold text-zinc-900 mb-2 tracking-tight">{number}</div>
